...
public class VocabularyConfig
{
	...
	{
		return Collections.unmodifiableList(subjectTypes);
	}

	public List<String> getArticleRoutes()
	{
		return Collections.unmodifiableList(articleRoutes);
	}

	public List<String> getArticleVehicles()
	{
		return Collections.unmodifiableList(articleVehicles);
	}

	public List<String> getAdministrationMeans()
	{
		return Collections.unmodifiableList(administrationMeans);
	}

	public List<String> getInVitroDurations()
	{
		return Collections.unmodifiableList(inVitroDurations);
	}

	public List<String> getInVivoDurations()
	{
		return Collections.unmodifiableList(inVivoDurations);
	}
	...
	{
		return Collections.unmodifiableList(articleTypes);
	}
	...
	{
		return Collections.unmodifiableList(sexes);
	}

	public List<String> getOrgans()
	{
		return Collections.unmodifiableList(organs);
	}
