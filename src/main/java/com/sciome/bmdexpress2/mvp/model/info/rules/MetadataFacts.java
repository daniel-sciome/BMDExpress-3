...
public class MetadataFacts extends FactsBase
{
	...
	{
		return "in vivo".equalsIgnoreCase(subjectType);
	}

	public boolean isInVitro()
	{
		return "in vitro".equalsIgnoreCase(subjectType);
	}

	public boolean isOralRoute()
	{
		return "oral".equalsIgnoreCase(articleRoute);
	}

	public boolean isInhaledRoute()
	{
		return "inhaled".equalsIgnoreCase(articleRoute);
	}

	public boolean isTransdermalRoute()
	{
		return "transdermal".equalsIgnoreCase(articleRoute);
	}

	public boolean isElectromagneticRadiation()
	{
		return "electromagnetic radiation".equalsIgnoreCase(articleType);
	}
}
